        ...
        <Container>
            {paragraphs != null && (
                <TextBlock2>
                    ...
                    <SubTitle>{paragraphs['SubTitle5']}</SubTitle>
                    <Body>{paragraphs['Body5']}</Body>
                    <Toggle list={props.list}></Toggle>
                    <StyledInput type="text" placeholder="Type something..." />

                    <SubTitle>{paragraphs['SubTitle6']}</SubTitle>
                    <Body>{paragraphs['Body6']}</Body>
                    <Toggle list={props.list}></Toggle>
                    <StyledInput type="text" placeholder="Type something..." />

                    <SubTitle>{paragraphs['SubTitle7']}</SubTitle>
                    <Body>{paragraphs['Body7']}</Body>
                    <Toggle list={props.list}></Toggle>
                    <StyledInput type="text" placeholder="Type something..." />
